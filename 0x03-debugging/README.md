...
<br>
Don’t add or remove any lines of code, as we will be checking your line count. You are only allowed to comment out existing code.<br>
You do not have to compile with -Wall -Werror -Wextra -pedantic for this task.<br>
<br>
2. 0 > 972?<br>
mandatory<br>
...
carrie@ubuntu:/debugging$
<br>
Output looks good for 04/01/1997! Let’s make a new main file 3-main_b.c to try a case that is a leap year: 02/29/2000.<br>
